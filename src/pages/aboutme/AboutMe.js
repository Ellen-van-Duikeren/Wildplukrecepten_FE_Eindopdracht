    ...
    return (
        <article className="page page--flex">
            <div className="left-side">
                ...
                <p className="margin-bottom1">Ik heb deze website wildplukrecepten ontwikkeld als eindopdracht voor mijn
                ...
                <p className="margin-bottom1"> Een van mijn hobbies is, zoals je al bedacht had, wildplukken. Wildplukken zorgt ervoor dat ik weer
                ...
                <p className="margin-bottom1">Het herkennen van de planten heb ik met name geleerd op de opleiding <a
                    ...
                    eromheen.</p>
                <p className="margin-bottom1">Liefs, Ellen </p>
            </div>
